...
//print_r($data);exit();
    ...
    public function get_recentchapters($id){
        ...
        $topics = $parent->result_array();
        foreach ($topics as $key => $value) {
            $sub = $this->get_chaptersubject($id);
            $topics[$key]['subject_id'] = $sub['data_id'];
    ...
    public function get_chapter_details_view($chapter,$teacher){
        ...
        foreach($result as $key => $value){
            ...
            if($type =='1'){
                ...
                if($teacher !=""){
                        $utypeid = $this->get_user_topic($typeid,$teacher);
...

    ...
    public function get_topic_qanda_answer($id,$question){
        ...
        $this->db->where('presentation_qanda_answers.qanda_question_id',$question);
...
function logout_teacher($id) {
   ...
   public function get_teacher_details($id){
    ...
    public function get_chapter_details_teacher($chapter,$teacher){
       ...
       //  return $result;
        ...
        foreach($result as $key => $value){
            ...
            $results[$key]['publish_status']=$value['publish_status'];
 ...
 public function get_batch($id){
        ...
        batch_end_time,course_id,institute_id';
 ...
 //        return $topics;       
 //    }
    public function get_chapter_details_webview($chapter,$teacher){
    ...
    public function get_topic_sub_child($id){
     ...
     public function get_keywords_topics($keyword){
        $keyword = $keyword;
        $this->db->distinct('presentation_topic.topic_title,topic_tags.tag');
        $this->db->select('presentation_topic.topic_title,presentation_topic.topic_id,presentation_topic.content,topic_tags.tag');
        $this->db->from('topic_tags');
        $this->db->where("(presentation_topic.topic_title  LIKE '%".$keyword."%'  OR  presentation.presentation_title LIKE '%".$keyword."%' )");
...
// print_r($topics);
    ...
    public function practice_audio($id,$uid,$type){
    ...
    public function get_course_students_subject($id){
        $this->db->select('data_parent');
        $this->db->where('data_id',$id);
        $this->db->where('data_status',1);
        $this->db->where('data_type',1);
