...
// $route['assign-teacher/(:num)/(:num)'] = 'institute/InstituteController/assign_teacher/$1/$1';

$route['add-assigned-teacher'] = 'institute/InstituteController/add_assigned_teacher';

$route['create-semester/(:num)'] = 'institute/InstituteController/create_semester/$1';
$route['add-semester'] = 'institute/InstituteController/add_semester';

$route['delete-semester/(:num)'] = 'institute/InstituteAjaxController/delete_semester/$1';
$route['publish-semester/(:num)'] = 'institute/InstituteController/publish_semester/$1';
$route['disable-semester/(:num)'] = 'institute/InstituteController/disable_semester/$1';
...
$route['presentation-draft-slide/(:num)'] = 'teacher/TeacherController/presentation_draft_slide/$1';
...
$route['practise-filter'] = 'AdminController/practise_filter';
...
$route['add-quest-row-all']='AdminAjaxController/add_quest_row_all';

$route['get-problem-solving'] = 'AdminController/get_problem_solving';
$route['edit-question-title'] = 'AdminController/edit_question_title';
...
$route['delete-ans-order']='AdminAjaxController/delete_ans_order';
...
$route['presentation-slide-copy/(:num)'] = 'PresentationController/presentation_slide_copy/$1';

// $route['presentation-slide-pre/(:num)'] = 'PresentationController/presentation_slide_pre/$1';
$route['presentation-slide-view-copy/(:num)'] = 'PresentationController/presentation_slide_view_copy/$1';
...
$route['create-text'] = 'PresentationController/create_text';

$route['load-images'] = 'PresentationController/loadDirectoryImages';
$route['get-practice'] = 'PresentationController/get_practice';
$route['get-slide-search'] = 'PresentationController/get_slide_search';
$route['presentation-webview/(:num)'] = 'PresentationController/presentation_slide_webview/$1';
$route['chapter-webview/(:num)'] = 'PresentationController/chapter_webview/$1';
$route['chapter-webview2/(:num)'] = 'PresentationController/chapter_webview2/$1';

$route['add-sametopic'] = 'PresentationController/add_sametopic';
$route['chapter-webview/(:any)/(:any)'] = 'PresentationController/chapter_webview/$1';
$route['create-sametext'] = 'PresentationController/create_sametext';

$route['update-topiccontent-position'] = 'PresentationController/update_topiccontent_position';
$route['update-topiccontent-size'] = 'PresentationController/update_topiccontent_size';
$route['create-chapterhead'] = 'PresentationController/create_chapterhead';
$route['update-chaptertitle-size'] = 'PresentationController/update_chaptertitle_size';
$route['update-chaptertitle-position'] = 'PresentationController/update_chaptertitle_position';
...
$route['app_problem_view/(:num)'] = 'welcome/view_question_web/$1';

// 16/11/2020

$route['get-exe'] = 'PresentationController/get_exercise';
$route['get-pdf'] = 'PresentationController/get_pdf';

$route['get-video'] = 'PresentationController/get_video';

//17-12-2020

$route['invited-student'] = 'teacher/TeacherController/invited_student';
//New
$route['invited-student/(:num)'] = 'teacher/TeacherController/invited_student';
$route['approve-student/(:num)'] = 'teacher/TeacherController/approve_students/$1';

// ************ bhagya - 04-01-2021 **************
$route['get-teacher-code'] = 'institute/InstituteAjaxController/get_teacher_code';
$route['teacher-semester'] = 'teacher/TeacherController/semester';
$route['add-favourite/(:num)'] = 'teacher/TeacherController/add_favourite/$1';
$route['remove-favourite/(:num)'] = 'teacher/TeacherController/remove_favourite/$1';
$route['teacher-timetable'] = 'teacher/TeacherController/teacher_time_table';

//athulya
$route['draft-practice-teacher/(:num)'] = 'teacher/TeacherController/draft_practice/$1';
$route['subjectlist_home'] = 'teacher/TeacherController/subjectlist_home';
// $route['update'] = 'PresentationController/update';
