...
<div class="container">
	<div class="row align-items-center mt-30p">
		...
		<div class="col-lg-4 col-md-5 col-sm-6 col-12">
			<div class="loginbox">
				...
				<form id="principal-login-form" action="" method="post">
				...
				<div class="full-block mt-30p"><input type="submit" value="Login"></div>
				<div class="full-block"><a href="javascript:void(0)" class="forgot-password-principal">Forgot password ?</a></div>
				</form>
			</div><!-- /.login box -->
   ...
   <!--  <script type="text/javascript">
      document.getElementById('institute').onclick = function() {
        alert('d');
    if (this.checked==true){
        alert('c');

       window.location = '<?=base_url()?>institute'; // Or in your case, window.location = 'whatever.html';
    }
