  ...
  <nav class="main-menu">
	...
	<li class="has-subnav">
	  ...
	  <ul>
	    ...
	    <div class="card" style="height: 657px; width: 280px; overflow-x: scroll;background-color: rgba(70,80,100,0.8);">
	 ...
	 <?php 
		...
		foreach($questions as $question){?>
		    ...
		    <div class="row slidenew <?= $question['question_id'] ?>" onclick="return addtopic('<?= $question['question_id'] ?>','<?= $question['question_title'] ?>','4')" data-id="<?= $question['question_id'] ?>" class=" " id="" style="border: 1px solid #a7a5a5;     height: 122px;
    width: 245px;  
    ...
    outline: none;">
		     ...
		     <span class="tspan"><?php echo $question['question_title'] ?></span>
			<br/> <br/>
	...
	<li class="has-subnav">
	 ...
	 <?php 
		...
		foreach($exercise as $exercises){?>
		    ...
		    <div class="row slidenew <?= $exercises['ex_topic_id'] ?>" onclick="return addtopic('<?= $exercises['ex_topic_id'] ?>','<?= $exercises['ex_topic_title'] ?>','5')" data-id="<?= $exercises['ex_topic_id'] ?>" class=" " id="" style="border: 1px solid #a7a5a5;     height: 122px;
    width: 245px;  
    background-size: contain ; background-size: 100%;
    background-position: center;
    background-repeat: no-repeat;  background: linear-gradient(0deg, rgba(236,239,244,1) 0%, rgba(255,255,255,1) 100%);
	...
	<li class="has-subnav">
	 ...
	 // print_r($pdf);	
		...
		foreach($pdf as $pdfs){?>
		    ...
		    <div class="row slidenew <?= $pdfs['video_id'] ?>" onclick="return addtopic('<?= $pdfs['video_id'] ?>','<?= $pdfs['video_title'] ?>','3')" data-id="<?= $pdfs['video_id'] ?>" class=" " id="" style="border: 1px solid #a7a5a5;     height: 122px;
    width: 245px;  
    background-size: contain ; background-size: 100%;
    background-position: center;
    background-repeat: no-repeat;  background: linear-gradient(0deg, rgba(236,239,244,1) 0%, rgba(255,255,255,1) 100%);
	 ...
	 <?php 
		...
		foreach($vedio as $vedios){
			...
			if($vedios['thumb_nail']){ ?>
				...
				<div class="row slidenew <?= $vedios['video_id'] ?>" onclick="return addtopic('<?= $vedios['video_id'] ?>','<?= $vedios['video_title'] ?>','1')" data-id="<?= $vedios['video_id'] ?>" class=" " id="" style="border: 1px solid #a7a5a5;     height: 122px;
    width: 245px;  
    background-size: contain ; background-size: 100%;
    background-position: center;
	...
	<button type="submit" class="searchButton">
	 ...
	 <?php 
		...
		foreach($presentations  as $slide){?>
		    ...
		    <div class="row slidenew <?= $slide['topic_id'] ?>" onclick="return addtopic('<?= $slide['topic_id'] ?>','<?= $slide['presentation_title'] ?>','2')" data-id="<?= $slide['topic_id'] ?>" class=" " id="" style="border: 1px solid #a7a5a5;     height: 122px;
    width: 245px;  background-image:url('<?php echo base_url().'uploads/background/'.$slide['backgroundimage']?>');
    background-size: contain ; background-size: 100%;
    background-position: center;
    background-repeat: no-repeat;  /*background: linear-gradient(0deg, rgba(236,239,244,1) 0%, rgba(255,255,255,1) 100%);*/
    border: 1px solid #ced0da;
...
<div class="card folderdiv" style="height: 657px; width: 280px; overflow-x: scroll;background-color: rgba(70,80,100,0.8);">
      <div class="card-header">
...
<div class="card imagefolderdiv <?=$entry?>" style="display: none; height: 657px; width: 280px; overflow-x: scroll;background-color: rgba(70,80,100,0.8);">
      <div class="card-header">
...
while (false !== ($entry = $dir->read())) {
   ...
   if (is_dir($path . '/' .$entry)) {
    $dirs[] = $entry; 
?>
  <div class="card imagediv <?=$entry?>background" style="display: none; height: 657px; width: 280px; overflow-x: scroll;background-color: rgba(70,80,100,0.8);">
      <div class="card-header">
...
<?php } else {
  ...
  <div class="card imagediv <?=$entry?>elements" style="display: none;height: 657px; width: 280px; overflow-x: scroll;background-color: rgba(70,80,100,0.8);">
      <div class="card-header">
...
<div class="topbar" style="height: 82px;width: 900px; background-color: #fff; top: 20px; left: 60px; position: absolute;">
...
if($tpcs["topic_backgroundimage"] ==""){
   echo '<div class="circle tcircle task" data-val="c'.$tpcs['id'].'"  data-id="'.$tpcs['id'].'" style="background-color:'.$tpcs['topic_backgroundcolor'].'; color:'.$tpcs['topic_color'].';  top:'.$topp.'px; left:'.$leftp.'px;   background-image:url('.base_url().'uploads/background/'.$tpcs["topic_backgroundimage"].'); position:absolute; height:'.$tpcs['topic_height'].'px;width:'.$tpcs['topic_width'].'px;  " ><div style="top:'.$tpcs['topic_content_position_top'].'px; left:'.$tpcs['topic_content_position_left'].'px; position:absolute;" class="tinymce-body tcontent" id="'.$tpcs['id'].'"  data-val="p'.$tpcs['id'].'" data-id="'.$tpcs['id'].'">'.$tpcs['topic_title'].'</div><span class="resume_create_up_link no_print">
      ...
      echo '<div class="circle mcircle task" data-val="c'.$tpcs['id'].'"  data-id="'.$tpcs['id'].'" style="background-color:'.$tpcs['topic_backgroundcolor'].'; color:'.$tpcs['topic_color'].';  top:'.$topp.'px; left:'.$leftp.'px;   background-image:url('.base_url().'uploads/background/'.$tpcs["topic_backgroundimage"].'); position:absolute; height:'.$tpcs['topic_height'].'px;width:'.$tpcs['topic_width'].'px;  " ><div style="top:'.$tpcs['topic_content_position_top'].'px; left:'.$tpcs['topic_content_position_left'].'px; position:absolute;" class="tinymce-body tcontent tdrag" id="'.$tpcs['id'].'"  data-val="p'.$tpcs['id'].'" data-id="'.$tpcs['id'].'">'.$tpcs['topic_title'].'</div><span class="resume_create_up_link no_print">
	  <span class="spacer"></span>
	  <a href="javascript:void(0)" data-id="'.$tpcs['id'].'" id="delete" class="delete-topic">
		<icon class="fa fa-trash icon_size24"></icon>
	  </a>
...
<style type="text/css">
  .about-accordion-open ul { width: 270px !important; }
