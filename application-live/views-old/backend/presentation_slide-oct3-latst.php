...
if($tpcs["practice_type"] !=1){
  ...
  if($tpcs["practice_type"] !=2){
	...
	if($tpcs["sametopcount"] ==0){
		...
		echo '<a a href="javascript:void(0)"  data-toggle="modal" data-target="#exampleModalsamesubtext" class="addsub-topic" title="Text Add"><img src="'.base_url().'uploads/icons/head.png" alt="presentation" ></a>';
