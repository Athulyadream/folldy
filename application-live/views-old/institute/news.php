  ...
  <div class="container">
    <div class="row">
      ...
      <div id="roles-table" class="col-12">
        ...
        <form action="<?=base_url('news-filter')?>" method="post" class="card filter" <?php if(!empty($this->session->userdata('news_filter'))) {?> style="display: block"<?php } else{?>  style="display: none;" <?php } ?>>
          <div class="card-body">
            <div class="row">
                ...
                <tr>
                  ...
                  <td class="text-right">
                    <?php
                      if($this->session->userdata('create')){
                    ?>
                      <a href="javascript:void(0)" data-id="<?=$data['news_id']?>" class="btn btn-secondary btn-sm edit-news-btn">Edit</a>
      ...
      <div id="add-role-form" class="col-12" style="display: none;">
        <form action="<?=base_url('add-news')?>" method="post" class="card" enctype="multipart/form-data" id="add-form">
          <div class="card-header">
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-md-6 col-lg-6">
                ...
                <div class="form-group">
                  <label class="form-label">Date</label>
                   <input type="text"  name="date" id="date" class="form-control previous" placeholder="MM/DD/YYYY" required="required" autocomplete="off">
      ...
      <div id="edit-news-form" class="col-12" style="display: none;">
        <form action="<?=base_url('edit-news')?>" method="post" class="card" enctype="multipart/form-data">
          <div class="card-header">
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-md-6 col-lg-6">
                ...
                <div class="form-group">
                  <label class="form-label">Date</label>
                   <input type="text"  name="edit_date" id="edit_date" class="form-control previous" placeholder="MM/DD/YYYY" required="required" autocomplete="off">
