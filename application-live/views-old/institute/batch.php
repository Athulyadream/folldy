  ...
  <div class="container">
    <div class="row">
      ...
      <div id="roles-table" class="col-12">
        ...
        <form action="<?=base_url('batch-filter')?>" method="post" class="card filter" <?php if(!empty($this->session->userdata('batch_filter'))) {?> style="display: block"<?php } else{?>  style="display: none;" <?php } ?>>
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-md-3 col-lg-3">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="filter_code" id="filter_code" placeholder="" value="<?= $filter_data['code']?>">
                </div>
              </div>
                ...
                <tr>
                  ...
                  <td>
                    <?php
                      if($this->session->userdata('create')){
                    ?>
                    <a href="<?php echo base_url() ?>create-semester/<?=$data['batch_id']?>" id="" class="btn btn-info btn-sm" >Create</a>
                    <?php
                    }
                    ?>
                  </td>
                  <td>
                    <?php
                      if($this->session->userdata('create')){
                    ?>
                    <a href="<?php echo base_url() ?>assign-teacher/<?=$data['batch_id']?>" id="" class="btn btn-info btn-sm" >View</a>
                    <?php
                    }
                    ?>
                  </td>
                  <td class="text-right">
                    <?php
                      if($this->session->userdata('create')){
                    ?>
                      <a href="javascript:void(0)" data-id="<?=$data['batch_id']?>" class="btn btn-secondary btn-sm edit-batch-btn">Edit</a>
                     <a href="<?php echo base_url() ?>time-table/<?=$data['batch_id']?>" id="" class="btn btn-secondary btn-sm ml-auto">Time Table</a>
                    <?php
                    }
                    ?>
                  </td>
      ...
      <div id="add-role-form" class="col-12" style="display: none;">
        <form action="<?=base_url('add-batch')?>" method="post" class="card" onsubmit="return check_batch(this)" id="add-form">
          <div class="card-header">
            ...
            <div class="row">
              <div class="col-md-6 col-lg-6">
                ...
                <div class="form-group">
                  ...
                  <input type="time"  name="start_time" id="start_time" class="form-control" required="required" min="07:00" max="20:00" >
                  
                </div>
                <div class="form-group">
                  <label class="form-label">End Time</label>
                  <input type="time"  name="end_time" id="end_time" class="form-control" required="required" min="07:00" max="20:00" >
              ...
              <div class="col-md-6 col-lg-6">
                ...
                <div class="form-group">
                  ...
                  <input type="checkbox" id="day1" name="day1" value="1" class="weekdays"> &nbsp; Mon &nbsp;
                  <input type="checkbox" id="day2" name="day2" value="2" class="weekdays"> &nbsp; Tue &nbsp;
                  <input type="checkbox" id="day3" name="day3" value="3" class="weekdays"> &nbsp; Wed &nbsp;
                  <input type="checkbox" id="day4" name="day4" value="4" class="weekdays"> &nbsp; Thu &nbsp;
                  <input type="checkbox" id="day5" name="day5" value="5" class="weekdays"> &nbsp; Fri &nbsp;
                  <input type="checkbox" id="day6" name="day6" value="6" class="weekdays"> &nbsp; Sat &nbsp;
      ...
      <div id="edit-batch-form" class="col-12" style="display: none;">
        <form action="<?=base_url('edit-batch')?>" method="post" class="card" onsubmit="return check_batch(this)">
          <div class="card-header">
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-md-6 col-lg-6">
                ...
                <div class="form-group">
                  <label class="form-label">Start Time</label>
                  <input type="time"  name="edit_start_time" id="edit_start_time" class="form-control" required="required" min="07:00" max="20:00" >
                  
                </div>
                <div class="form-group">
                  <label class="form-label">End Time</label>
                  <input type="time"  name="edit_end_time" id="edit_end_time" class="form-control" required="required" min="07:00" max="20:00" >
              ...
              <div class="col-md-6 col-lg-6">
                ...
                <div class="form-group">
                  <label class="form-label">Start Date</label>
                  <input type="text"  name="edit_start_date" id="edit_start_date" class="form-control upcoming" placeholder="MM/DD/YYYY" required="required"  autocomplete="off">
                  
                </div>
                <div class="form-group">
                  <label class="form-label">End Date</label>
                  <input type="text"  name="edit_end_date" id="edit_end_date" class="form-control upcoming" placeholder="MM/DD/YYYY" required="required"  autocomplete="off">
                  
                </div>
                <div class="form-group">
                  <label class="form-label week-label">Week Days</label>
                  
                  <input type="checkbox" id="edit_day1" name="edit_day1" value="1" class="weekdays"> &nbsp; Mon &nbsp;
                  <input type="checkbox" id="edit_day2" name="edit_day2" value="2" class="weekdays"> &nbsp; Tue &nbsp;
                  <input type="checkbox" id="edit_day3" name="edit_day3" value="3" class="weekdays"> &nbsp; Wed &nbsp;
                  <input type="checkbox" id="edit_day4" name="edit_day4" value="4" class="weekdays"> &nbsp; Thu &nbsp;
                  <input type="checkbox" id="edit_day5" name="edit_day5" value="5" class="weekdays"> &nbsp; Fri &nbsp;
                  <input type="checkbox" id="edit_day6" name="edit_day6" value="6" class="weekdays"> &nbsp; Sat &nbsp;
...
<script type="text/javascript">
function check_batch(event){
  //var weekdays = $('.weekdays').val();
  var cerr =1;
  
  if($('#code-error').val() == 1) cerr = 0;
  $(event).find('.invalid-feedback').remove();

  // if($('.weekdays').prop("checked") == true){
  //   alert('checked');
  // }
  // else{
  //   alert('not');
  // }
            ...
            $.each($("input[class='weekdays']:checked"), function(){
            ...
            if(favorite != ""){
              $('form').find('button[type="submit"]').attr('disabled',false);
              //$(event).find('.weekdays').removeClass('is-invalid');
              var cerr = 1;
            }
            else{
              $.each($("input[class='weekdays']:checked"), function(){

                $(event).find($(this)).addClass('is-invalid');

            });
              //$(event).find('.weekdays').addClass('is-invalid');
                alert('Please select week days.');
              // $(event).find('.week-label').after('<div class="invalid-feedback">Please select week days.</div>');
              var cerr = 0;
            }
