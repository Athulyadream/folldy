...
if($tpcs['type']==6){
  ...
  $imageb = base_url().'uploads/background/'.$tpcs["topic_backgroundimage"];
					    ...
					    echo '<div class="circle  task" data-val="c'.$tpcs['id'].'"  data-id="'.$tpcs['id'].'" style="background-color:'.$tpcs['topic_backgroundcolor'].'; color:'.$tpcs['topic_color'].';  top:'.$topp.'px; left:'.$leftp.'px;   background-image:url('.$imageb.'); position:absolute; height:'.$tpcs['topic_height'].'px;width:'.$tpcs['topic_width'].'px;  " >';
