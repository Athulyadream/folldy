      ...
      <div id="roles-table" class="col-12">
        ...
        <div class="card">
          <div class="card-header">
            <h3 class="card-title">Chapter Design</h3>
            <div class="ml-auto">
                            ...
                            ?>
                              <tr>
                                ...
                                <td>
                                   ...
                                   //    print_r($data['teacher_id']);
                                   //    print_r($this->session->userdata('teacher_id'));

                                   // }

                                      if($data['type']=='2'){
                                        // echo "p".$data['publish_status'];
                                 if($data['draft']=='1'){
                             ...
                             // }
                                ...
                                <?php 
                                 ...
                                 if($data['publish_status'] == 1  ){ 
                                  // echo "published"; 
?>
<a href="<?=base_url('chapter-content-unpublish-teacher')?>/<?=$data['type']?>/<?=$data['type_id']?>/<?=$data['id']?>/<?=$data['chapter_id']?>" data-id="<?=$data['id']?>" class="btn btn-primary btn-sm ">Unpublish</a>
  <?php                              }else{ ?>
                                   <a href="<?=base_url('chapter-publish-teacher')?>/<?=$data['type']?>/<?=$data['type_id']?>/<?=$data['id']?>/<?=$data['chapter_id']?>" data-id="<?=$data['id']?>" class="btn btn-success btn-sm ">Publish</a>
                                  <?php } }else{
if($data['publish_status'] != 1  ){ 
...
<a href="<?=base_url()?>presentation-draft-slide/<?=$data['type_id']?>"  class="btn btn-info btn-sm ">Draft</a>
                                <?php }else{
                                  echo "Published by another teacher";
                                }
                                 } }else if($data['type']=='4'){
