...
?>
<img src="<?=base_url()?>uploads/background/pictures-folder.png" style=" width:150px; height:100px;"> 
...
<div class="card imagefolderdiv <?=$classentry?>" style="display: none; height: 657px; width: 350px; overflow-x: scroll;background-color: rgba(70,80,100,0.8);">
      <div class="card-header">
...
$classentrys = str_replace(' ', '', $entry);
    ...
    $dirs[] = $entry; 
?>
  <div class="card imagediv <?=$classentrys?>background" style="display: none; height: 657px; width: 350px; overflow-x: scroll;background-color: rgba(70,80,100,0.8);">
      <div class="card-header">
...
<div class="col-md-6"><img src="<?=base_url().$image ?>"
      ...
      alt="Random image" style=" width:150px; height:70px; margin-bottom: 5%;" style="
    padding: 1%;
...
<?php } else {
  ...
  <div class="card imagediv <?=$classentrys?>elements" style="display: none;height: 657px; width: 350px; overflow-x: scroll;background-color: rgba(70,80,100,0.8);">
      <div class="card-header">
...
<div class="col-md-6"><img src="<?=base_url().$image ?>" style=" width:150px; height:70px; margin-bottom: 5%;" class="<?=$entry.$i?>"
       onclick = "addImagetopic('<?=$entry?>/elements/<?=basename($image)?>','<?=$classentrys.$i?>')" 
   ...
   <?php 
    ...
    foreach($presentations  as $slide){
      ...
      ?>
        ...
        <div class=" slidenew <?= $slide['topic_id'] ?> plusPresentation"   data-id="<?= $slide['topic_id'] ?>" class=" " id="" style="border: 1px solid #a7a5a5;     height: 150px;
...
<div class="col-md-12">
  ...
  <div class="form-group">
            ...
            <input type="text" class="form-control key-tags" id="question_tags" name="question_tags"  placeholder="Enter Question Tags" required="">
    </div>
...
<div class="card-body ">
        ...
        <div class="row" style="overflow-x: scroll;font-size: 25px !important;">
  ...
  <figcaption>Practice</figcaption>
   ...
   <?php 
    ...
    foreach($questions as $question){?>
        ...
        <div class="row slidenew <?= $question['question_id'] ?>" onclick="return addtopic_practice('<?= $question['question_id'] ?>','<?= $question['question_code'] ?>')" data-id="<?= $question['question_id'] ?>" class=" " id="" style="border: 1px solid #a7a5a5;     height: 150px;
    width: 300px;  
    background-size: contain ; background-size: 100%;
    background-position: center;
    background-repeat: no-repeat;  background: linear-gradient(0deg, rgba(236,239,244,1) 0%, rgba(255,255,255,1) 100%);
...
<div class="topbar" style="height: 82px;width: 800px; background-color: #fff; top: 20px; left: 60px; position: absolute;">
  ...
  <div class="col-sm-7 toolbars" style="font-size: 25px;"></div>
  <div class="col-sm-2" style="padding-top: 3%;"> New Topic <a href="javascript:void(0)"  data-toggle="modal" data-target="#exampleModaltopic" title="Topic Add">
...
if($tpcs["topic_backgroundimage"] ==""){
   echo '<div class="circle tcircle task" data-val="c'.$tpcs['topic_id'].'"  data-id="'.$tpcs['topic_id'].'" style="background-color:'.$tpcs['topic_backgroundcolor'].'; color:'.$tpcs['topic_color'].';  top:'.$topp.'px; left:'.$leftp.'px;   background-image:url('.$tpcs["topic_backgroundimage"].'); position:absolute; height:'.$tpcs['topic_height'].'px;width:'.$tpcs['topic_width'].'px;  " > <div class="tcontent tinymce-body" id="i'.$tpcs['topic_id'].'"  data-val="p'.$tpcs['topic_id'].'" data-id="'.$tpcs['topic_id'].'"  style="top:'.$tpcs['topic_content_position_top'].'px; left:'.$tpcs['topic_content_position_left'].'px;font-size:'.$tpcs['topic_fontsize'].'px;position:absolute;">'.$tpcs['topic_title'].'</div><span class="resume_create_up_link no_print"><span> <a href="javascript:void(0)" data-id="'.$tpcs['topic_id'].'" id="deletei" class="delete-topic"><icon class="fa fa-trash icon_size24"></icon></a>

   <a href="javascript:void(0)" class="plus" data-id="'.$tpcs['topic_id'].'">
   <icon class="fa fa-plus icon_size24"></icon>
   </a><a href="javascript:void(0)" class="arrows"  data-id="'.$tpcs['topic_id'].'"><icon class="fa fa-arrows icon_size24"></icon></a> </span> </div>';
 }else{
      echo '<div class="circle mcircle task" data-val="c'.$tpcs['topic_id'].'"  data-id="'.$tpcs['topic_id'].'" style="background-color:'.$tpcs['topic_backgroundcolor'].'; color:'.$tpcs['topic_color'].';  top:'.$topp.'px; left:'.$leftp.'px;   background-image:url('.$tpcs["topic_backgroundimage"].'); position:absolute; height:'.$tpcs['topic_height'].'px;width:'.$tpcs['topic_width'].'px;  " > <div class="tcontent tdrag tinymce-body" id="i'.$tpcs['topic_id'].'"  data-val="p'.$tpcs['topic_id'].'" data-id="'.$tpcs['topic_id'].'"  style="top:'.$tpcs['topic_content_position_top'].'px; left:'.$tpcs['topic_content_position_left'].'px;font-size:'.$tpcs['topic_fontsize'].'px;position:absolute;">'.$tpcs['topic_title'].'</div>
      <span class="resume_create_up_link no_print"><span> <a href="javascript:void(0)" data-id="'.$tpcs['topic_id'].'" id="deletei" class="delete-topic"><icon class="fa fa-trash icon_size24"></icon></a>
      <a href="javascript:void(0)" class="plus" data-id="'.$tpcs['topic_id'].'"><icon class="fa fa-plus icon_size24"></icon></a>
 
 <a href="javascript:void(0)"  class="arrows"  data-id="'.$tpcs['topic_id'].'"><icon class="fa fa-arrows icon_size24"></icon></a>
       </span> </div>';
 }
...
if(!empty($presentation_topic['image'])){
 foreach ($presentation_topic['image'] as $img) {
              ...
              echo '<div class="timage" data-id="'.$img["image_id"].'"   style=" position:absolute;top:'.$topi.'px;left:'.$lefti.'px;background-image:url('.base_url().'uploads/chapter/'.$img["image"].'); height:'.$img["image_height"].'px;width:'.$img["image_width"].'px;"><span class="resume_create_up_link no_print">
...
<?php if($presentation_topic['content']){
  ...
  ?>
        <div class="contents tdragcontent " id="cont<?=$topic_id?>" data-id="<?=$topic_id?>" style="height:<?=$presentation_topic["content_height"]?>px; width:<?=$presentation_topic["content_width"]?>px;" >
...
<div class="modal " id="modalFolderName" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  ...
  <div class="modal-body">
      ...
      <input type="text"  name="new" id="new"  class="form-control" required="required">
      <!-- pattern="[A-Za-z]{2,}" title="only accept alphabets" -->
      </div>
  ...
  <div class="modal-body">
    ...
    <div class="row">
      ...
      <div class="form-group ">
        ...
        <div  id="title" style="font-size: 25px;" class="form-control tinymce-title"></div>
      </div></div>
      <div class="col-md-6 col-lg-6">
      <div class="form-group">
...
<div class="col-sm-3" onclick="return hideshowimage_title('<?=$classentrys?>elementstitle',1);"><img src="<?=base_url()?>uploads/background/<?=$entry?>/elements/<?=$firstFile2?>"  style="width:300px; height:120px; "><span class=""> <?=$entry?> </span>

</div>
    
<?php }else{ ?>

<div class="col-sm-3" onclick="return hideshowimage_title('<?=$classentrys?>elementstitle',1);"><img src="<?=base_url()?>uploads/background/pictures-folder.png"  style=" width:300px; height:120px; "><span class=""> <?=$entry?> </span></div>
<?php } ?>
...
?>
  ...
  <!-- <div class="col-md-6"  onclick="return hideshow('<?=$entry?>');"><img src="<?=base_url()?>uploads/background/<?=$entry.$firstFile?>" style=" width:150px; height:100px;">  -->
<div class="col-sm-3" onclick="return hideshowimage_title('chapter',1);"><img src="<?=base_url()?>uploads/chapter/<?=$firstFile2?>"  style=" width:300px; height:120px; "><span class=""> Image Gallery </span></div>
    
<?php }else{ ?>

<div class="col-sm-3" onclick="return hideshowimage_title('chapter',1);"><img src="<?=base_url()?>uploads/background/pictures-folder.png"  style=" width:300px; height:120px; "><span class=""> <?=$entry?> </span></div>
<?php } ?>
    ...
    
{
    ...
    ?>                     
<!-- <button class="tablinks" onclick="openCity(event,'<?=$entry?>')"><?=$entry?></button> -->
<div class="col-sm-3"><img src="<?=base_url().$image ?>" style=" width:300px; height:120px; padding: 5%;" class="<?=$entry.$i?> imm"
    ...
    
{
    ...
    ?>                     
<!-- <button class="tablinks" onclick="openCity(event,'<?=$entry?>')"><?=$entry?></button> -->
<div class="col-sm-6"><img src="<?=base_url().$image ?>" style=" width: 440px;
    height: 220px; margin-bottom: 5%;" class="<?=$entry.$i?> imm"
       onclick = "addImagetopic_title('chapter/<?=basename($image)?>','<?=$entry.$i?>')" 
...
var emailBodyConfig = {
  ...
  menubar: false,
  inline: true,
  fontsize_formats: "8pt 10pt 12pt 14pt 18pt 24pt 40pt 44pt 48pt 50pt 54pt 58pt 64pt 68pt 72pt",
    ...
    $.ajax({
       ...
       console.log(out);
        ...
        for(var i=0;i<out.data.length;i++){
          ...
          html += '<div class="col-md-12"><img src="<?=base_url()?>uploads/chapter/'+out.data[i]['chapter_image']+'" class="chapter<?=$i?>" style="height:150px;width:300px" onclick = "addchapter(';
...
if(out.data[i]['topic_id'] != <?=$topic_id?>){
          ...
          html += '  <div class=" slidenew '+out.data[i]['topic_id']+' plusPresentation"  data-id="'+out.data[i]['topic_id']+'" class=" " id="" style="border: 1px solid #a7a5a5;     height: 150px; width: 294px;  background-image:url(<?php echo base_url()?>uploads/slide/'+out.data[i]['content_slide']+');background-size: contain ; background-size: 100%;background-position: center;'
...
html +=' </div>';
        html += ' <span class="tspan">'+out.data[i]['ttitle']+'</span><br/> <br/>';
         ...
         if(out.data.sub.length>0){
          ...
          for(var i=0;i<out.data.sub.length;i++){
            ...
            if(out.data.sub[i].sub.length>0 || out.data.sub[i].image.length>0 || out.data.sub[i]['content']!=""){
                html += '  <div class="  '+out.data.sub[i]['topic_id']+' "  data-id="'+out.data.sub[i]['topic_id']+'" class=" " id="" style="border: 1px solid #a7a5a5;     height: 150px; width: 294px;  background-image:url(';
               html += "'"+'<?php echo base_url()?>uploads/slide/'+out.data.sub[i]['content_slide']+"'"+');background-size: contain ; background-size: 100%;background-position: center;'
                html += 'background-repeat: no-repeat;  border: 1px solid #ced0da;  border-radius: 3px; -webkit-border-radius: 3px; -moz-border-radius: 3px;outline: none;" onclick="return gettabs(';
...
// });
 ...
 var dragpositionsi = '';
  $('.timage').draggable({
    ...
    $(this).css("border"," 1px dashed #726465");
...
$(document).ready(function(){
 ...
 $("#closemenu").click(function(){
  ...
  $(".circle").click(function(){
    ...
    $(this).css("border"," 1px dashed #999");
     $(this).find('.tcontent').css("border"," 1px dashed #999");
...
$(".contents").click(function(){
  ...
  // $(".circle").hover(function(){
  //   $('.circle').css("border","none");
  //   $(this).css("border","2px 1px dashed #999");
  // });
