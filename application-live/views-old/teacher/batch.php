            ...
            <table class="table card-table table-vcenter text-nowrap">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <a href="<?=base_url('teacher-timetable').'?id='.$data['batch_id']?>" class="btn btn-info btn-sm">View</a>
                  </td>
                  <td>
                    <a href="<?=base_url('teacher-semester').'?id='.$data['batch_id']?>" class="btn btn-info btn-sm">View</a>
