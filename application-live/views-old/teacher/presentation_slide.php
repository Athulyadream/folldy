...
<li >
  ...
  <li >
    <a href="<?=base_url()?>presentation-slide-view-teacher/<?=$presentation_topic['topic_id']?>" class="btn btn-primary-outline present" target="_blank"  title="Present">
      <!-- <i class="fa fa-eye nav-icon" aria-hidden="true"></i> -->
       <figure >
  ...
  <li>
  <a href="<?=base_url()?>chapter-design-teacher?id=<?=$this->session->userdata('chapter_id')?>" id="" class="btn btn-primary-outline">
