  ...
  <div class="container">
    <div class="row">
          ...
          <div class="offset-lg-4 col-md-4 alert alert-danger text-center">
            <button type="button" class="close" data-dismiss="alert"></button>
            Error unable to approve student!
          </div>
          <?php
            }
      ...
      <div id="roles-table" class="col-12">
        ...
        <div class="card">
          <div class="card-header">
            <h3 class="card-title">Invited Students</h3>
            <div class="ml-auto">
                              ...
                              <tr>
                                ...
                                <td>
                                  <?php if($data['status'] == 1){ ?>
                                    <a href="<?=base_url('approve-student/'.$data['invite_id'])?>" class="btn btn-success btn-sm" onclick="return confirm('Are you sure you want to approve student?')">Approve</a>
                                  <?php }
                                  elseif($data['status'] == 2){
                                    echo "<label style='color:red'>Approved</label>";
                                  } ?>
                                  <!-- <a href="<?=base_url('teacher-chapters').'?id='.$data['data_id']?>" class="btn btn-info btn-sm">View</a> -->
