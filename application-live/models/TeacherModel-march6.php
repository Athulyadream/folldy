...
class TeacherModel extends CI_Model {
    ...
    //      $this->db->join('chapter_content_publish','chapter_content_publish.chapter_content_id=chapter_design.id  AND chapter_content_publish.batch_id ='.$this->session->userdata('batch_id'),'left');
    //     $this->db->where("(chapter_content_publish.batch_id ='".$this->session->userdata('batch_id')."' OR chapter_content_publish.batch_id  is NULL)");
