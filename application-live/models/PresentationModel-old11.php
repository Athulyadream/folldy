...
class PresentationModel extends CI_Model {
    ...
    public function chapter_content_webview($chapter,$teacher){
        ...
        foreach ($results as $key => $value) {
            ...
            if($type =='1'){
                ...
                // $results[$x]['link'] = base_url().'presentation-slide-view/'.$utypeid;
                $results[$key]['link'] = 'presentation/'.$typeid;
    ...
    public function chapter_teachercontent_webview($chapter,$teacher){
