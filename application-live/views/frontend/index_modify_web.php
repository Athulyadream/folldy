...
html, body {
    /* background-image: url(../images/page-bg-green.png); */
...
.answer-area .table-box table td {
...
.oredr-active {
    background: rgb(80 153 105) !important;
    opacity: 65%;
}

.answer-area .table-box table tr.table-header td {
    background: #f8f9fa;
}
.mr-10p {
...
/*.answer-area .table-box table td .sub_table_fixed {
     background: rgb(205, 224, 184); 
...
*/
.answer-area .table-box table tr:last-child td:not(.sub_table_fixed):not(.ans-d-line){
     border-bottom: 2px solid rgba(0,0,0,0.5) !important;
}

/*.answer-area .table-box table tr:last-child td .sub_table_fixed {
     border-bottom: 0px solid rgba(0,0,0,0.5) !important;
}*/
...
/*.answer-area .table-box table tr td:last-child, .answer-area tr.table-header td:last-child {
...
float: right;width: 90%;float: right;padding: 0 15px 50px;z-index: 1;padding-left: 0px;
        ...
        <canvas id="can" width="1400" height="600" style="/* position:absolute; *//* top:10%; *//* left:10%; */display:none;"></canvas>
            ...
            <div class="col-md-6 col-sm-12 col-12 question-area" style="    flex: 0 0 100%;
    max-width: 100%;" id="question-area">

            <div class="question-div" style="float: left;
    width: 100%;
    margin: 0px 0px 30px;
    /*min-height: 80vh;*/
    padding-left: 16px;
...
$flag=1;
    ...
    $flag=0;
     ...
     if(count($qt_table)>1){
       if(!empty($qt_table[0]['qt_vals'])||!empty($qt_table[0]['qt_text']['text_val'])||!empty($qt_table[0]['transactions'])){
             if($flag==1){
                  ...
                  <a href="#" class="ans-pag-link q_left" style="    
    width: 44px;
    height: 36px;
    line-height: 30px;
    font-weight: 500;
    font-size: 16px;
    color: rgba(50,60,80,0.4);margin-bottom: 11px;margin-top: -101px;"><i style="font-size: 32px" class="fas fa-caret-left"></i></a>


                                <!-- <div class="question" style="font-size: .9em;    background: #f8f9fa;">
                                ...
                                <!-- /.question -->
                                 ...
                                 <a href="#" class="ans-pag-link q_right" style="   
    width: 44px;
    height: 36px;
    line-height: 30px;
    font-weight: 500;
    font-size: 16px;
    color: rgba(50,60,80,0.4);margin-bottom: 11px;margin-top: -101px;
    margin-left: 15px;"><i style="font-size: 32px" class="fas fa-caret-right"></i></a>
...
<!-- <?php if($key_tb==0||$key_tb==1){ echo 'class ="table-box quest_table active"'; }else{ echo 'class="table-box quest_table " style="display:none;"'; } ?> -->
           <div id="qt-div<?=$key_tb?>" data-id="<?=$key_tb?>"  data-width="<?=$single_width;?>"  class="table-box quest_table active"  style="margin-bottom:20px;<?php if($single_width!=0){?>width:100%; <?php } else{?>width:100%<?php }?>">
...
$content = str_replace("<p><br></p>","",$tab_q['header_note']);
 ...
 <?php
    ...
    ?>
                ...
                <table class="" style=" border: 1px solid rgba(0,0,0,0.5);">
                    <tr class="table-header" <?php
                    if(!array_filter($cols_name)) {

                  // if($cols_name[0]==''){
                    ?> style="height: 0px;font-size: 0.9em;"<?php }else{ ?> style="font-size: 0.9em;"  <?php } ?> >
            ...
            <!--  data-simplebar -->
             <?php
               ...
               foreach ($tab_q['transactions'] as $key_t => $data_n) {
                ...
                $last_trans=$key_t;
                        ?>
            <div id="transations_id<?=$key_t?>"    data-id="<?=$key_t?>" <?php if($key_t==0){ echo 'class ="transations active"'; }else{ echo 'class="transations" style="display:none;"'; } ?>  style="max-width:100%;float:left;width:100%;    background: rgb(248 249 250);">
...
<!-- min-height: 80vh;
  max-height: 93vh;
 -->
        <div class="col-md-6 col-sm-12 col-12 " id="answer-area" style="   
     padding-right: 62px;    margin-bottom: 30px;">
...
<div class="table_new">
      ...
      ?>
          ...
          <div id="<?=$tabimg?>" data-id="<?=$key?>" data-format="<?=$format['p_format_id']?>" data-tableid="<?=$format['table_id']?>" style="display: none;" <?php if($key==0){ echo 'class ="ans_tab1  problme-tab active" '; }else{ echo 'class="ans_tab1  problme-tab"'; } ?>  >
               ...
               <div class="col-lg-12 col-md-12 col-sm-12 col-12" id="" style="border: 1px solid rgba(0, 40, 100, 0.1);">
...
//print_r($problem_format);
 ...
 <p class="text-center answer-table-header" style="margin-bottom:-11px;min-height: 36px;font-size: 13px;">
                     ...
                     <div class="answer-table-box table-box card">
                      ...
                      <?php if(count($problem_format)>1){
                        ?>

                                 <a href="#" class="shift_left_pr pr-pag-link" style="   
    width: 44px;
    height: 36px;
    line-height: 30px;
    font-weight: 500;
    font-size: 16px;
    color: rgba(50,60,80,0.4);       margin-left: -48px;
    position: fixed;"><i style="font-size: 32px" class="fas fa-caret-left"></i></a>

    <a href="#" class="shift_right_pr pr-pag-link" style="   
    width: 44px;
    height: 36px;
    line-height: 30px;
    font-weight: 500;
    font-size: 16px;
    color: rgba(50,60,80,0.4);margin-bottom: 9px;      
        position: fixed;
    
    margin-left: 560px;
"><i style="font-size: 32px" class="fas fa-caret-right"></i></a>
<?php
                  ...
                  // if($cols_name[0]==''){
                    ?> style="height: 0px;font-size: 11px;display: none;"<?php }else{ ?> style="font-size: 11px;   " <?php } ?>> 
                    <?php
...
<?php } ?>
 ...
 <!-- <a href="#" class="ans-pag-link shift_left" style="   
    width: 44px;
    height: 36px;
    line-height: 30px;
    font-weight: 500;
    ...
    <a href="#" class="ans-pag-link shift_right" style="   
    width: 44px;
    height: 36px;
    line-height: 30px;
    font-weight: 500;
    font-size: 16px;
    color: rgba(50,60,80,0.4);margin-left: -48px;
    position: fixed;"><i style="font-size: 32px" class="fas fa-caret-right"></i></a>
 -->
                    ...
                    <div style="text-align: center; font-size: 1.2em"><?=$table_header['header_note']?></div>
    ...
    color: rgba(50,60,80,0.4);    margin-bottom: 9px;
    position: fixed;
       margin-left: 573px;"><i style="font-size: 32px" class="fas fa-caret-right"></i></a>
     <?php } ?>
                  ...
                  // if($cols_name[0]==''){
                    ?> style="border: 1px solid rgba(0,0,0,0.5);"<?php }else{ ?> style="" <?php } ?>>
                        <table <?php
                    if(!array_filter($cols_name)){

                  // if($cols_name[0]==''){
                    ?> style="display: none;"<?php }else{ ?> style="border: 1px solid rgba(0,0,0,0.5);" <?php } ?>>
...
<?php
                ...
                <div style="font-size: 1.1em"><?=$table_header['footer_note']?></div>
...
<?php }?>
   ...
   <!-- <a href="#" class="ans-pag-link shift_left" style="   
    ...
    font-weight: 500;
    font-size: 16px;
    color: rgba(50,60,80,0.4);margin-bottom: 9px;    margin-left: -28px;
    margin-top: -103px;"><i style="font-size: 32px" class="fas fa-caret-left"></i></a>
    ...
    font-weight: 500;
    font-size: 16px;
    color: rgba(50,60,80,0.4);margin-bottom: 9px;    margin-right: -51px;
    margin-top: -103px;"><i style="font-size: 32px" class="fas fa-caret-right"></i></a> -->
                 ...
                 <div class="number-controls" style="    margin: 0 1px 0 0;">
                    ...
                    <ul>
                      ...
                      <!--   <li><a href="#" class="shift_left_pr pr-pag-link"><i class="fas fa-caret-left"></i></a></li> -->
                        ...
                        <li class="" data-id="2"><a href="#" style="width: 31px;    color: #354052;" data-id="2" class="show_image_answer"> <img src="<?= base_url().'assets_main/assets/images/problem-format.png';?>"></a></li>
...
<!--                     <h4></h4>
 -->                    <ul style="">
                        <li class="active preview"><a href="#" style="padding: 0 1px;min-width: 41px;" class="show_question show_question_new">Q</a></li>
                        <li class=" preview"><a href="#" style="padding: 0 1px;min-width: 41px;"  class="show_full">Q & A</a></li>
                        <li class="preview"><a href="#" style="padding: 0 1px;min-width: 41px;"  class="show_answer">A</a></li>
                    </ul>
...
$(document).ready(function(){
   ...
   $('.show_image_answer').addClass('disabled');

 
       return false;
});

 $('.oredr-active').click(function () {

  $(this).removeClass('oredr-active');
   ...
   $('.show_question').click(function () {
        ...
        $(".q_left").show();
            ...
            $('.question-div').css('padding-right','30px');
                                  ...
                                  //alert("fgfgg");
                                            var act = $(".problme-tab.active1");
                                              ...
                                              if($(tab).html()){
                                                  ...
                                                  act.removeClass('active1').hide();
                                                  $('#table_img1').addClass('active1').show();
                                                  $('#table-ft1').show();
                                              }
 ...
 $(".shift_left").hide();
  $(".shift_right").hide();
    $(".q_right").hide();
       ...
       // $('.question-div').css('max-height','62vh');
              $('#answer-area').css('flex','0 0 100%');
                $('#answer-area').css('max-width','100%');


              $('.question-div').css('flex','0 0 65%');
              $('.question-div').css('max-width','100%');
...
$('.show_image_answer').removeClass('disabled');
