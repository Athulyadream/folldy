...
<!--                <div class="question" style="min-height: 20px;background: #fffede">
 -->
                               <div class="question" style="min-height: 5px;">
...
if(!in_array($data['content_order_id'], $content_ord)){
                                  ?>
                                </br>
                                <?php
                       ...
                       <?php
                        array_push($content_ord, $data['content_order_id']);
                         }
                            //$k $key_t;
                         $tr++;
                        }
...
<!-- min-height: 36px;
 -->
 <p class="text-center answer-table-header" style="margin-bottom:-5px;">
...
// print_r(sizeof($table_width));
                                                   ...
                                                   ?> 
                                                           <td width="<?=$table_width[$sub]['width'];?>%" data-ansid="<?=$tableans[$m]['id'];?>" data-column="<?php echo $i ;?>" class="sub_table_fixed connected text-right">
...
// print_r($ids);                              
                                                if(!in_array($table_sub[$sub1]['id'], $ids)){
                                                                    ...
                                                                    ?>  <li class="disc1 <?=$class;?> " data-ansid="<?=$table_sub[$sub1]['id']?>" data-column="<?php echo $i ;?>"  style="display: none;border: none;"><?=$table_sub[$sub1]['ans_values']?></li>
                                                    ...
                                                    <td width="<?=$table_width[$sub]['width'];?>%" data-ansid="<?=$tableans[$m]['id'];?>" data-column="<?php echo $i ;?>" class="sub_table_fixed connected">
                                                        <?php
                                                                          // if($cols_answer[$i]){
...
$(".sub_table_fixed").each(function(){

     var thisH = $(this).height();
   if (thisH > maxHeight) { maxHeight = thisH; }


                              // $(this).find('td_line').height();
                           });

  $(".sub_table_fixed").each(function(){

    // if($(this).find('td_line').length >1){
