                            ...
                            for(var i = 0; i < myarray1.length; i++)
                            {
                                                        ...
                                                        // $('.ans_tab').find('.itemconnect[data-ansid="'+myarray1[i]+'"][data-column="'+myarraycol[i]+'"]').css('background','rgba(120, 189, 243, 0.41)');
                                                         ...
                                                         // $('.ans_tab').find('.itemconnect[data-ansid="'+myarray1[i]+'"][data-column="'+myarraycol[i]+'"]').addClass('oredr-active');
                                                          ...
                                                          $('.ans_tab').find('.itemconnect[data-ansid="'+myarray1[i]+'"][data-column="'+myarraycol[i]+'"]').addClass('oredr-active');
                                                          // $('.ans_tab').find('.itemconnect[data-ansid="'+myarray1[i]+'"][data-column="'+myarraycol[i]+'"]').css('background','rgba(120, 189, 243, 0.41)');
                                                           $('.ans_tab').find('.disc1[data-ansid="'+myarray1[i]+'"][data-column="'+myarraycol[i]+'"]').parent().addClass('oredr-active');
...
//   });
        ...
        //  $('.trans_question').append('<li class="disc trans_question1">'+$(this).attr('data-name')+'</li>');
           ...
           // $('#trans_img').attr('src','');
            ...
            if($.trim($('#quest_helpimg_' + $(this).attr('data_id')+$(this).attr('data-table')).html())) {
              $('#trans_img').attr('src',$.trim($('#quest_helpimg_' + $(this).attr('data_id')+$(this).attr('data-table')).html()));
            $('#trans_img_a').attr('href',$.trim($('#quest_helpimg_' + $(this).attr('data_id')+$(this).attr('data-table')).html()));
          }
            ...
            if($.trim($('#quest_helptext_' + $(this).attr('data_id')+ $(this).attr('data-table')).html())){
                $('.help-text').html('<p>'+$('#quest_helptext_' + $(this).attr('data_id')+$(this).attr('data-table')).html()+'</p>');
            }
            else $('.help-text').html('');
            ...
            // if($.trim($('#quest_format_' + $(this).attr('data_id')).html())){
              //console.log();
              var id1=$.trim($('#quest_format_' + $(this).attr('data_id')+$(this).attr('data-table')).html());
              var id3=$.trim($('#quest_ans_value' + $(this).attr('data_id')+$(this).attr('data-table')).html());
              var id4=$.trim($('#quest_ans_col' + $(this).attr('data_id')+$(this).attr('data-table')).html());
              var id5=$.trim($('#quest_trans_all' + $(this).attr('data_id')+$(this).attr('data-table')).html());
              var id6=$.trim($('#quest_format_table' + $(this).attr('data_id')+$(this).attr('data-table')).html());


             var id2=$.trim($('#quest_format_value' + $(this).attr('data_id') + $(this).attr('data-table')).html());


                  console.log($('#quest_format_value' + $(this).attr('data_id') + $(this).attr('data-table')).html());
                  console.log($(this).attr('data_id') + $(this).attr('data-table'));
                      ...
                      // $('.tab-format[data-format="'+id1+'"]').addClass('active');
                        ...
                        //           });
                                    ...
                                    if($.trim($('#quest_format_table' + $(this).attr('data_id')+$(this).attr('data_table')).html())){
                                      $(".tab-format.active").removeClass('active');
                            ...
                            for(var i = 0; i < myarray1.length; i++)
                            {
                              ...
                              // alert(myarraycol[i]);
                                                        ...
                                                        // $('.ans_tab').find('.itemconnect[data-ansid="'+myarray1[i]+'"][data-column="'+myarraycol[i]+'"]').css('background','rgba(120, 189, 243, 0.41)');
                                                          ...
                                                          // $('.ans_tab').find('.disc1[data-ansid="'+myarray1[i]+'"][data-column="'+myarraycol[i]+'"]').parent().css('background','rgba(120, 189, 243, 0.41)');
                                                          // $('.ans_tab').find('.itemconnect[data-ansid="'+myarray1[i]+'"][data-column="'+myarraycol[i]+'"]').css('background','rgba(120, 189, 243, 0.41)');
...
//                           $('#answer-area').addClass(' offset-md-2 col-md-10 full');
...
//                       if($('#answer-area').hasClass('offset-md-2 col-md-10')){
...
//                         act.addClass('active1');
//                          $('#answer-area').removeClass('col-md-12');
//                          $('#answer-area').addClass(' offset-md-2 col-md-10');
//                     var single_wid2 = $(act).attr('data-width');
//                      if(single_wid2!=0){
//                     $(act).css('width',single_wid2+'%');
//                   }
...
// if($('#answer-area').find('.tab.active').is(':visible')){
                ...
                $('#answer-area').removeClass(' offset-md-2 col-md-10');
                $('#answer-area').removeClass('col-md-12');
                // $('#answer-area').addClass(' col-md-12');
             ...
             $('#answer-area').removeClass(' offset-md-2 col-md-10');
                ...
                $(act).css('width',single_wid2+'%');
                    ...
                    if($('#answer-area').hasClass('offset-md-2 col-md-10')){
                         ...
                         $("#answer-area").toggleClass("offset-md-2 col-md-10 full"); 
...
// white-space:pre
                  var htm='<li class="disc '+class1+'" draggable="true" style="border:none;text-decoration:underline;text-underline-position: under;height:'+height+'px">'+val+'</li>' ;
                 ...
                 var htm='<li class="disc u_line '+class1+'" draggable="true" style="text-decoration:underline;text-underline-position: under;height:'+height+'px">'+val+'</li>' ;
...
// white-space:pre
                  ...
                  if(parent.hasClass('sub_table')){
                  var htm='<li class="disc '+class1+'" draggable="true" style="border:none;height:'+height+'px">'+val+'</li>' ;
                  ...
                  var htm='<li class="disc '+class1+'" draggable="true" style="height:'+height+'px">'+val+'</li>' ;
