...
<h4 class="btntitle">Gallery Images</h4>
  <div class="search">
  <input type="text" id="imagesearchFol1" class=" imagesearchFol searchTerm" placeholder="What are you looking for?">
...
<h4 class="btntitle">Gallery Images</h4>
  <div class="search">
  <input type="text" id="imagesearchFol" class="searchTerm imagesearchFol" placeholder="What are you looking for?">
  <button type="button" onclick="return getImageFol();" class="searchButton">
    <i class="fa fa-search"></i>
     </button>
   </div>
