...
<!-- <script src="//maxcdn.bootstrapcdn.com/bootstrap/4.1.1/js/bootstrap.min.js"></script> -->
    ...
    <link rel="stylesheet" type='text/css' media='all' href="<?=base_url()?>static/css/webslides.css?version=1">
...
// print_r($tpcs['countofcontent']);
                    if($tpcs['countofcontent'] == 1){

                      if($tpcs['sametopcount'] !=1 && $tpcs['practice_type']==0){
                         echo '<a href="'.$tpcs['topic_id'].'" target="_blank" class="practice linka">';
                      }    
                    }

                      if($tpcs['practice_id']!=0 && $tpcs['practice_type']==1 ){
                        echo '<a href="'.$tpcs['practice_id'].'" target="_blank" class="practice">';
                      }
