        ...
        <footer class="footer">
            ...
            <div class="col-12 col-lg-auto mt-3 mt-lg-0 text-center">
                ...
                <a href="http://primalcodes.com/" target="new">
                    <img src="http://kmstore.in/market/assets/images/primalcode-icon.svg" height="20px" alt="Primal Codes Logo"> Primal Codes
                </a>
            </div>
        </footer>
    </div>
    ...
    <div id="myModal" class="modal fade" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary change-password-btn">Save</button>
            </div>
            </div>
