...
//athulya chapter
         $this->db->join('chapter_publish','chapter_publish.chapter_id = data.data_id AND chapter_publish.teacher_id='.$teacher.' AND chapter_publish.batch_id ='.$batch ,'left');
...
function logout_teacher($id) {
   ...
   public function get_teacher_details($id){
    ...
    public function get_chapter_list_teacher($subject,$teacher,$batch){
       ...
       // $this->db->where('chapter_publish.publish_status',1);
        $this->db->where('data_parent',$subject);
        $this->db->where('chapter_publish.batch_id',$batch);
...
// die();
    ...
    public function list_assignment_teacher($id){
        // print_r($this->session->userdata('admin_role'));
        // die();
    ...
    public function list_closed_assignment_teacher($id){
        $batch = array();
        $this->db->select('*');
        $this->db->where('teacher_id',$id);
        // $this->db->where('batch_id',$batch);
    ...
    public function get_wall($batch,$limit,$offset,$uid){
        ...
        $this->db->select('*');
        $this->db->where("(batch_id='$batch' OR batch_id=0)");
    ...
    public function get_wall_teacher($batch,$limit,$offset,$uid){
