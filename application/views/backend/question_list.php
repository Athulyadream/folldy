...
// print_r($tab_q['transactions']);
             if($priorit_ids==3){
              ...
              <div class="row col-lg-8 col-md-12 qst-transaction-row"  style="margin-top: 20px;">
 ...
 -->
     ...
     foreach ($tab_q['transactions'] as $key => $trans) {
       ...
       ?>
          ...
          <div class="col-md-12 col-lg-12 qst-transaction" class="" style="display: flex;margin-bottom: 20px;" >
   ...
   //
     ...
     //$('.append-quest-row').append(html);
      ...
      //alert('cxhggxcgc');
        ...
        data:{row:no,last:i,table_id:table,order:order},
        type:'post',
        success: function(out){
            out = JSON.parse(out);
            if(out.status == 1){
   ...
   //
     ...
     //$('.append-quest-row').append(html);
      ...
      //alert('cxhggxcgc');
        ...
        data:{row:i,table_id:table,order:order},
        type:'post',
        success: function(out){
            out = JSON.parse(out);
            if(out.status == 1){
    ...
    $('.edit-qst-div').find('.qst-transaction-row').each(function (index, value) {
     ...
     // var h=m-1;
           ...
           // $('.qst-transaction-row').show();
             ...
             var html='<div class="col-lg-2 col-md-12 " style=""></div><div class="row col-lg-9 col-md-12 qst-transaction-row"  style="margin-top:20px" data-order="'+m+'"  data-type="paragrph">';
    ...
    $('.edit-qst-div').find('.qst-transaction-row').each(function (index, value) {
     ...
     // var h=m-1;
           ...
           // $('.qst-transaction-row').show();
             ...
             var html='<div class="col-lg-2 col-md-12 " style=""></div><div class="row col-lg-9 col-md-12 qst-transaction-row"  style="margin-top:20px" data-order="'+m+'"  data-type="sentnce">';
...
if(transaction!=''){
            ...
            type:'post',
            data:{transaction:transaction,type:type,order:order,tr_id:tr_id},
            success: function(out){
                var out = JSON.parse(out);
                if(out.status == 1){
                    var trans=out.data;
   ...
   // var nos = $.trim($('#table_cols').val());
    if(table){
        $.ajax({
            ...
            type:'post',
            data:{tab_id:table,q_id:q_id,order_id:dataid,tablename:tablename},
            success: function(out){
                var out = JSON.parse(out);
                if(out.status == 1){
