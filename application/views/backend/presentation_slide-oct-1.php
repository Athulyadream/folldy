...
<!-- <div class="search">
  <input type="text" id="searchTermslide" class="searchTerm" placeholder="What are you looking for?">
  <button type="submit" class="searchButton" onclick="return getSlidesearch();">
...
<!-- <button id="imagesave" class="btn btn-primary">save</button> -->
   ...
   <div class="row"  id="folderappend<?=$classentrys?>background">
...
<div class="row" id="elementsappend<?=$classentrys?>elements"></div>
        </div>
</div>
<?php }}} ?>
...
if($tpcs["topic_backgroundimage"] ==""){
   ...
   echo '<div class="circle tcircle task" data-val="c'.$tpcs['topic_id'].'"  data-id="'.$tpcs['topic_id'].'" style="background-color:'.$tpcs['topic_backgroundcolor'].'; color:'.$tpcs['topic_color'].';  top:'.$topp.'px; left:'.$leftp.'px;   background-image:url('.$tpcs["topic_backgroundimage"].'); position:absolute; height:'.$tpcs['topic_height'].'px;width:'.$tpcs['topic_width'].'px;  " >';
    ...
    echo'<span data-html2canvas-ignore="true"  class="resume_create_up_link no_print plus'.$tpcs['topic_id'].' pl"><a href="javascript:void(0)" data-id="'.$tpcs['topic_id'].'" class="pla"  ><icon class="fa fa-plus icon_size24"></icon></a></span>
   <span data-html2canvas-ignore="true" class="resume_create_up_link no_print del'.$tpcs['topic_id'].' dl"><a href="javascript:void(0)" data-id="'.$tpcs['topic_id'].'" id="deletei" class="delete-topic"><icon class="fa fa-trash icon_size24"></icon></a>';
if($tpcs["practice_type"] ==0){
...
// echo '<a a href="javascript:void(0)"  data-toggle="modal" data-target="#exampleModaltitle" title="Text Add"><icon class="fa fa-header icon_size24"></icon></a>';
   ...
   echo '<a href="javascript:void(0)" class="arrows"  data-id="'.$tpcs['topic_id'].'"><icon class="fa fa-arrows icon_size24"></icon></a> </span> </div>';
      ...
      echo '<div class="circle mcircle task" data-val="c'.$tpcs['topic_id'].'"  data-id="'.$tpcs['topic_id'].'" style="background-color:'.$tpcs['topic_backgroundcolor'].'; color:'.$tpcs['topic_color'].';  top:'.$topp.'px; left:'.$leftp.'px;   background-image:url('.$tpcs["topic_backgroundimage"].'); position:absolute; height:'.$tpcs['topic_height'].'px;width:'.$tpcs['topic_width'].'px;  " >';
...
<div class="modal " id="exampleModalsamesubtext" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  ...
  <div class="modal-body">
    ...
    <div class="row">
      ...
      <div class="form-group ">
        ...
        <input type="hidden" name="text_topic" id="text_topic"  value="<?= $topic_id?>"  >
      </div></div>
      <div class="col-md-6 col-lg-6">
  ...
  <div class="modal-footer">
    <button type="button" class="btn btn-secondary" data-dismiss="modal" >Close</button>
    <button type="submit" class="btn btn-primary" onclick="return addsamesubtext();" >Create</button>
  </div>
  </form>
    </div>
  </div>
...
<div class="col-sm-6"><img src="<?=base_url().$image ?>" style=" width: 440px;
    height: 220px; margin-bottom: 5%;" class="<?=$entry.$i?> imm"
       onclick = "addImagetopic_title_sub('chapter/<?=basename($image)?>','<?=$entry.$i?>')" 
...
$(document).ready(function(){
 ...
 $("#closemenu").click(function(){
  ...
  $(".circle").click(function(){
    ...
    $(this).css("outline","1px solid #da2626");
     $(this).find('.tdrag').css("outline","1px solid #2969ab");
