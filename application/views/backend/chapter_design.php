                            ...
                            ?>
                              <tr>
                                ...
                                <td>
                                 ...
                                 if($data['type']=='2'){
                                  ?>
                                  <a href="<?=base_url()?>presentation-edit-slide/<?=$data['type_id']?>"  class="btn btn-info btn-sm ">Edit Presentation</a>
                                <?php 
                              }

                                 if($data['publish_status'] == 1 && $data['teacher_id']==$this->session->userdata('admin_id')){ echo "published"; }else{ ?>
                                   <a href="<?=base_url('chapter-publish')?>/<?=$data['type']?>/<?=$data['type_id']?>/<?=$data['id']?>/<?=$data['chapter_id']?>" data-id="<?=$data['id']?>" class="btn btn-primary btn-sm ">Publish</a>
                                  <?php } ?>
                                </td>
                                <td>
                                  <?php
