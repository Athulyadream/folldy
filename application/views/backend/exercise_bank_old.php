  ...
  <div class="container">
    <div class="row">
      ...
      <div id="add-role-form" class="col-12" style="display: none;">
        <form action="<?=base_url('add-exercise-bank')?>" method="post" class="card">
          <div class="card-header">
        ...
        <form action="<?=base_url('edit-exercise-bank')?>" method="post" class="card">
          ...
          <div class="row">
              ...
              <div class="col-md-6 col-lg-6">
                <div class="form-group">
                    <label class="form-label">Tags</label>
                    <input type="text" class="form-control" id="edit_file_tags" name="edit_file_tags"  placeholder="Enter Keywords" >
                  </div>
              </div>
            </div>
          </div>
