   ...
   <?php
            ...
            foreach ($batchs as $key => $value) {?>
              <div class="col-md-3 col-sm-12 col-12">
                          ...
                          <div class="subject-block" style="border-bottom: #ccc;">
          ...
          <div class="row">
            <?php 
                ...
                foreach($event as $row){ 
                  ...
                  ?>
                  <div class="col-lg-3 col-md-6 col-sm-6 col-12 mb-20p">
                    ...
                    <div class="recent-chapters-block">
                      ...
                      <img src="<?= base_url('uploads/events/'.$row['event_image']) ?>" style=" height: 10rem;">
