...
<html lang="en" dir="ltr">
  <head>
   ...
   <link rel="shortcut icon" type="png" href="<?= base_url()?>home_assets/images/favicon.png" id="favicon" data-original-href="<?= base_url()?>home_assets/images/favicon.png" />
    ...
    <link rel="stylesheet" href="<?= base_url()?>home_assets/css/layout.css?19">
...
<div class="container">
  <div class="row align-items-center mt-30p">
    <div class="col-lg-8 col-md-7 col-sm-6 col-12 mt-30p mb-30p">
      <div class="full-block text-center mb-30p"><img src="<?= base_url()?>home_assets/images/innovate-tagline.png" alt=""></div>
      <div class="full-block text-center"><img src="<?= base_url()?>home_assets/images/letsunfold-tagline.png" alt=""></div>
    </div>
    <div class="col-lg-4 col-md-5 col-sm-6 col-12">
      <div class="loginbox">
        <div class="alert mb-20p"></div>
         <form id="institute-login-form" class="card" action="<?=base_url()?>institute-login" method="post">
        ...
        <div class="row mobileapp-badges">
                  <div class="col-md-6 col-sm-6 col-12 mb-20p"><input onchange="window.location.href='<?=base_url()?>teacher'" type="checkbox" id="teacher" value="1" > Teacher  </div>
                  <div class="col-md-6 col-sm-6 col-12 mb-20p" > <input type="checkbox" id="institute" checked="checked" > Institute</div>
        </div>
                <div class="card-body p-6">
                  ...
                  <div class="form-footer">
                    <input type="submit" >
                    <a href="javascript:void(0)" class="float-right small forgot-password" >I forgot password</a>
                  </div>
                </div>
              </form>
      
      </div><!-- /.login box -->
      <div class="full-block text-center mb-30p">
        <div class="row mb-30p mobileapp-badges">
          <div class="col-12"><p class="text-center mb-20p">Get the app</p></div>
          <div class="col-md-6 col-sm-6 col-12 mb-20p"><a href="#"><img src="<?= base_url()?>home_assets/images/badge-appstore.png" alt=""></a></div>
          <div class="col-md-6 col-sm-6 col-12 mb-20p"><a href="#"><img src="<?= base_url()?>home_assets/images/badge-googleplay.png" alt=""></a></div>
        </div>
