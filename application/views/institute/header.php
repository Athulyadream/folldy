...
<!--   <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datepicker/1.4.1/css/bootstrap-datepicker3.css"/>
 -->
    ...
    <script>
      ...
      require(["jquery","jquery_ui","fileupload","select2","confirm"], function($) {
    ...
    <div class="page">
      <div class="page-main">
        <div class="header py-4">
          <div class="container">
            <div class="d-flex">
              <a class="header-brand" href="<?=base_url('institute-dashboard')?>">
                ...
                <div class="dropdown">
                  <a href="#" class="nav-link pr-0 leading-none" data-toggle="dropdown">
                    ...
                    <span class="ml-2 d-none d-lg-block">
                      <span class="text-default"><?=$this->session->userdata('ins_user_name')?></span>
                    </span>
                  </a>
                  <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                    ...
                    <a class="dropdown-item" href="<?=base_url('institute-logout')?>">
            ...
            <div class="row align-items-center">
              <div class="col-lg order-lg-first">
                <ul class="nav nav-tabs border-0 flex-column flex-lg-row">
                  <li class="nav-item">
                    <a href="<?=base_url('institute-dashboard')?>" class="nav-link"><i class="fe fe-home"></i> Dashboard</a>
                  </li>
                  <?php
                  ...
                  <?php
                   ...
                   <?php }
                     ...
                     if($batch){
                        ?>
                        <li class="nav-item">
                        <a href="<?=base_url('batch')?>" class="nav-link"><i class="fa fa-user"></i> Batch</a>
                      </li>
                     <?php }
                     if($students){
                        ?>
                        <li class="nav-item">
                        <a href="<?=base_url('students')?>" class="nav-link"><i class="fa fa-user"></i> Students</a>
                      </li>
                     <?php }
                     if($news){
                        ?>
