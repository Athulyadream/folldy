                ...
                <tr>
                  ...
                  <td>
                    <?php
                      if($this->session->userdata('create')){
                    ?>
                    <a href="<?php base_url() ?>create-semester/<?=$data['batch_id']?>" id="" class="btn btn-info btn-sm" >Create</a>
                    <?php
                    }
                    ?>
                  </td>
                  <td>
                    <?php
                      if($this->session->userdata('create')){
                    ?>
                    <a href="<?php base_url() ?>assign-teacher/<?=$data['batch_id']?>" id="" class="btn btn-info btn-sm" >View</a>
                    <?php
                    }
                    ?>
                  </td>
                  <td class="text-right">
                    ...
                    ?>
                     ...
                     <a href="<?php base_url() ?>time-table/<?=$data['batch_id']?>" id="" class="btn btn-secondary btn-sm ml-auto">Time Table</a>
                    <?php
                    }
                    ?>
                  </td>
