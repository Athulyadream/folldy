  ...
  <div class="container">
    <div class="row">
          ...
          <div class="offset-lg-4 col-md-4 alert alert-danger text-center">
            <button type="button" class="close" data-dismiss="alert"></button>
            Error adding teacher! Please contact tech support.
          </div>
          <?php
            }
          ...
          <div class="offset-lg-4 col-md-4 alert alert-danger text-center">
            <button type="button" class="close" data-dismiss="alert"></button>
            Error updating teacher! Please contact tech support.
          </div>
          <?php } ?>
      <div id="roles-table" class="col-12">

        <form action="<?=base_url('teacher-filter')?>" method="post" class="card filter" <?php if(!empty($this->session->userdata('teacher_filter'))) {?> style="display: block"<?php } else{?>  style="display: none;" <?php } ?>>
          <div class="card-body">
            <div class="row">
              ...
              <!-- <div class="col-md-3 col-lg-3">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="filter_username" id="filter_username" placeholder="eg: teacher123" value="<?= $filter_data['username']?>">
                </div>
              </div> -->
        ...
        <div class="card">
          <div class="card-header">
            ...
            <div class="ml-auto">
              ...
              ?>
                <a href="#" id="add-role-btn" class="btn btn-primary ml-auto">Add Teacher</a>
              <?php
                }
              ?>
            </div>
            ...
            <table class="table card-table table-vcenter text-nowrap">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <?=$data['teacher_email'].' / '.$data['teacher_phone']?>
                  </td>
                  <td>
                  ...
                  <td class="text-right">
                    <?php
                      if($this->session->userdata('create')){
                    ?>
                      <a href="javascript:void(0)" data-id="<?=$data['teacher_id']?>" class="btn btn-secondary btn-sm edit-teacher-btn">Edit</a>
      ...
      <div id="add-role-form" class="col-12" style="display: none;">
        <form action="<?=base_url('add-teacher')?>" method="post" class="card" onsubmit="return checkmobile_teacher(this)" id="add-form">
          <div class="card-header">
            ...
            <div class="row">
              <div class="col-md-6 col-lg-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control name" name="teacher_name" id="teacher_name" placeholder="Enter Name" required>
                </div>
                <div class="form-group">
                  <label class="form-label">Teacher Email</label>
                  <input type="email" class="form-control email" name="teacher_email" id="teacher_email" placeholder="Enter Email" required onchange="check_email(this)">
                  <input type="hidden" class="error" id="email-error" value="0">
                </div>
                <div class="form-group">
                  <label class="form-label">Teacher Mobile</label>
                  <input type="text" class="form-control mobile numberonly" name="teacher_phone" id="teacher_phone" placeholder="Enter Mobile Number" required onchange="check_mobile(this)">
              ...
              <div class="col-md-6 col-lg-6">
               <!--  <div class="form-group">
                  ...
                  <input type="text" class="form-control username" name="teacher_username" id="teacher_username" placeholder="Enter Username" required onchange="return check_username(this)">
                  <input type="hidden" class="error" id="username-error" value="0">
                </div> -->
                <div class="form-group">
                  <label class="form-label">Teacher Password</label>
                  <div class="input-group">
                    <input type="text" class="form-control" name="teacher_password" id="teacher_password" placeholder="Enter Password" required pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters">
          ...
          <div class="card-footer text-right">
            <div class="d-flex">
              ...
              <a href="<?=base_url('teachers')?>" class="btn btn-link">Cancel</a>
      ...
      <!-- edit Form -->
      <div id="edit-teacher-form" class="col-12" style="display: none;">
        <form action="<?=base_url('edit-teacher')?>" method="post" class="card" onsubmit="return checkmobile_teacher(this)">
          <div class="card-header">
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-md-6 col-lg-6">
                <div class="form-group">
                  <label class="form-label">Teacher Name</label>
                  <input type="text" class="form-control name" name="edit_teacher_name" id="edit_teacher_name" placeholder="Enter Name" required>
                  <input type="hidden" name="edit_id" id="edit_id">
                </div>
                <div class="form-group">
                  <label class="form-label">Teacher Email</label>
                  <input type="email" class="form-control email" name="edit_teacher_email" id="edit_teacher_email" placeholder="Enter Email" required onchange="check_email(this)">
                </div>
                <div class="form-group">
                  <label class="form-label">Admin Status</label>
                  <label class="custom-control custom-checkbox custom-control-inline" style="margin-top: 10px;">
                    <input type="checkbox" class="custom-control-input" name="edit_teacher_status" id="edit_teacher_status">
              ...
              <!--   <div class="form-group">
                  <label class="form-label">Teacher Username</label>
                  <input type="text" class="form-control username" name="edit_teacher_username" id="edit_teacher_username" placeholder="Enter Username" required onchange="return check_username(this)">
                </div> -->
                <!-- <div class="form-group">
                ...
                <div class="form-group">
                  <label class="form-label">Teacher Mobile</label>
                  <input type="text" class="form-control mobile numberonly" name="edit_teacher_phone" id="edit_teacher_phone" placeholder="Enter Mobile Number" required onchange="check_mobile(this)">
                </div>
                <div class="form-group">
                  <label class="form-label">Subject</label>
                  <select class="form-control subject js-example-basic-multiple2-selected" name="edit_subject[]" id="edit_subject" required >
                    <option selected="selected" disabled selected>Select</option>
                    <?php
                      foreach($subject as $data){
                        echo '<option value="'.$data['data_id'].'" style="text-transform:capitalize" id="crs_'.$data['data_id'].'" >'.$data['data_name'].'</option>';
                      }
                    ?>
                  </select>
                </div>
...
<script type="text/javascript">
  function check_mobile(event){
    ...
    var id = $('#edit_id').val();
        ...
        $.ajax({
            type:"post",
            url:base_url+"get-teacher-phone",
...
<script type="text/javascript">
  function check_email(event){
    ...
    var id = $('#edit_id').val();
        $.ajax({
            type:"post",
            url:base_url+"get-teacher-email",
...
<script type="text/javascript">
  function check_username(event){
    ...
    var id = $('#edit_id').val();
        $.ajax({
            type:"post",
            url:base_url+"get-teacher-username",
