                            ...
                            ?>
                              <tr>
                                ...
                                <?php 
                                 ...
                                 if($data['publish_status'] == 1 && $data['teacher_id']==$this->session->userdata('teacher_id')){ echo "published"; }else{ ?>
                                   <!-- <a href="<?=base_url('chapter-publish-teacher')?>/<?=$data['type']?>/<?=$data['type_id']?>/<?=$data['id']?>/<?=$data['chapter_id']?>" data-id="<?=$data['id']?>" class="btn btn-primary btn-sm ">Publish</a> -->
                                    ...
                                    <a href="javascript:void(0);" data-id="<?=$data['id']?>" class="btn btn-success btn-sm publish-chaptercontent-btn" onclick="return publishchaptercontent(<?=$data['type']?>,<?=$data['type_id']?>,<?=$data['id']?>,<?=$data['chapter_id']?>)">Publish</a>
                                  <?php } }else{ ?>
...
<div id="myModal" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <!-- Modal content-->
    <form action="<?=base_url('chapter-publish-teacher')?>" method="post" class="card">
