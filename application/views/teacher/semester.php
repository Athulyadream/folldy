                            ...
                            ?>
                              <tr>
                                ...
                                <td><?=$data['semester_name']?></td>
                                    <td><?php echo date('d-m-Y', strtotime(str_replace('-','/', $data['semester_start_date']))); ?>

                                  </td>
                                <td><?php echo date('d-m-Y', strtotime(str_replace('-','/', $data['semester_end_date']))); ?></td>
                                <td><?php
                                ...
                                <td><a href="<?=base_url('teacher-papers').'?id='.$data['semester_id']?>" class="btn btn-info btn-sm">View</a>
