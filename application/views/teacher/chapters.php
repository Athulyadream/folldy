      ...
      <div id="roles-table" class="col-12">
        ...
        <div class="card">
          <div class="card-header">
            ...
            <div class="ml-auto">
              <!-- <a href="#" id="filter-btn" class="btn ml-auto" data-toggle="tooltip" title="Filter"><i class="fa fa-filter"></i></a> -->
                 <!-- 2021 athulya -->
                          <a href="<?=base_url('teacher-plan')?>" class="btn btn-info btn-sm">Plan</a>        
          ...
          <div class="table-responsive">
                        ...
                        <?php
                            ...
                            ?>
                              <tr>
                                ...
                                <td><?php if($data['publish_status']==1){ echo "PUBLISHED";}else{ ?>
            ...
            <a href="javascript:void(0);" data-id="<?=$data['data_id']?>" class="btn btn-success btn-sm publish-chapter-btn" onclick="return publishchapter(<?=$data['data_id']?>)">Publish</a>
...
<div id="myModal" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <!-- Modal content-->
    <form action="<?=base_url('publish-chapter')?>" method="post" class="card">
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-md-12 col-lg-12">
                <div class="form-group">
                  <label class="form-label">Publish Content</label>
                  <textarea class="form-control" name="publish_content" id="publish_content" placeholder="Enter Publish Content" cols="5" rows="3" required></textarea> 
                  <input type="hidden" name="pchapter" id="pchapter">
                </div>
              </div>
            </div>
          </div>
