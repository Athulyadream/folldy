...
// alert($('.show_question_new').parent().html());
...
// modify//
        ...
        // });
             ...
             $('.show_image_answer').click(function () {
                 ...
                 $(this).show();
                   ...
                   if($('#question-area').hasClass('full_q')){
                     ...
                     $(".quest_table").each(function(){
                      ...
                      $( ".transations" ).first().css( "display", "block" );
...
parent.removeClass('oredr-active');
                ...
                if($(this).hasClass('u_line')){
                  ...
                  var htm='<li class="disc '+class1+'" draggable="true" style="border:none;text-decoration:underline;text-underline-position: under;">'+val+'</li>' ;
                 ...
                 var htm='<li class="disc u_line '+class1+'" draggable="true" style="text-decoration:underline;text-underline-position: under;">'+val+'</li>' ;
                  ...
                  if(parent.hasClass('sub_table')){
                  var htm='<li class="disc '+class1+'" draggable="true" style="border:none;">'+val+'</li>' ;
                  ...
                  var htm='<li class="disc '+class1+'" draggable="true" style="">'+val+'</li>' ;
