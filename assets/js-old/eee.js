                ...
                if(out.status == 1){
                        ...
                        for (var j = 0; j <= answer.length; j++) {
                           ...
                           var html='';
                             for(var i=0;i<cols;i++){
                                 var value_array=[answer[i].column_one_value,answer[i].column_two_value,answer[i].column_three_value,answer[i].column_four_value,answer[i].column_five_value,
                     answer[i].column_six_value,answer[i].column_seven_value,answer[i].column_eight_value,answer[i].column_nine_value,answer[i].column_ten_value,
                     ];
                 ...
                 html += '<input type="checkbox" class="form-control1" name="is_underline'+i+'[]"    id="is_underline" style="margin: 12px;"></div></div>';
                   ...
                   // }
                        ...
                        // out +=' <div class="col-md-2 col-lg-2"> <div class="form-group"><label class="form-label">Under-line</label><input type="checkbox" class="form-control1" name="is_underline[]" id="is_underline" style="margin: 12px;"></div></div>';
                       var num2 = 1;
